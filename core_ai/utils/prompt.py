...
- Nếu người dùng đã chọn loại thiệp cụ thể (birthday hoặc graduation), **BẮT BUỘC** phải tuân theo loại thiệp đó.
- Nếu người dùng chưa chọn loại thiệp, hãy dựa trên yêu cầu nội dung thiệp để chọn thể loại phù hợp.
- **birthday**: thiệp sinh nhật - dùng khi chúc mừng sinh nhật, tuổi mới
- **graduation**: thiệp tốt nghiệp - dùng khi chúc mừng tốt nghiệp, hoàn thành học tập
